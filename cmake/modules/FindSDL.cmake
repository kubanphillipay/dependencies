...
find_library(MYSDL_LIBRARY_RELEASE
  NAMES SDL2
  HINTS
    ENV SDLDIR
...
find_library(MYSDL_LIBRARY_DEBUG
  NAMES SDL2d
  HINTS
    ENV SDLDIR
  PATH_SUFFIXES lib ${VC_LIB_PATH_SUFFIX}
...
#message( STATUS "SDL_LIBRARY_RELEASE: ${SDL_LIBRARY_RELEASE}" )
#message( STATUS "SDL_LIBRARY_DEBUG: ${SDL_LIBRARY_DEBUG}" )

#SDL_LIBRARY_TEMP


#message( STATUS "SDL_LIBRARY_SHARED_TEMP ${SDL_LIBRARY_SHARED_TEMP}" )
...
if( SDL_BUILD_SHARED )
    find_program(SDL_SHARED_DEBUG
      NAMES SDL2d${CMAKE_SHARED_LIBRARY_SUFFIX}
    )
   find_program(SDL_SHARED_RELEASE
      NAMES SDL2${CMAKE_SHARED_LIBRARY_SUFFIX}
    )
endif()
...
select_library_configurations(MYSDL)
select_library_configurations(SDLMAIN)

#message( STATUS "MY_SDL_LIBRARIES: " ${MYSDL_LIBRARY} )
#message( STATUS "SDLMAIN_LIBRARY: " ${SDLMAIN_LIBRARY} )


#NEEDS SDL MAIN
if( NOT SDL_BUILDING_LIBRARY )
    #message (STATUS "NEEDS SDL MAIN" )
    set( SDL_LIBRARY_TEMP ${SDLMAIN_LIBRARY} ${MYSDL_LIBRARY} )
#DOES NOT NEED SDL MAIN
else ()
    #message (STATUS "NO SDL MAIN" )
    set( SDL_LIBRARY_TEMP ${MYSDL_LIBRARY} )
endif()

#message( STATUS "SDL_LIBRARY_TEMP ${SDL_LIBRARY_TEMP}" )


if( SDL_LIBRARY_TEMP )
#  # For SDLmain
#  if(SDLMAIN_LIBRARY_DEBUG AND NOT SDL_BUILDING_LIBRARY)
...
#  endif()
  ...
  #message( STATUS "AFTER SET FINAL SDL_LIBRARY: ${SDL_LIBRARY}" )
...
#message( STATUS "PRE FINAL SDL_LIBRARY: ${SDL_LIBRARY}" )
...
#message( STATUS "FINAL SDL_LIBRARY: ${SDL_LIBRARY}" )